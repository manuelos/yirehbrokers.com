...
<?php
	...
	$gantry->addStyle('YOUBUY.css');
	$gantry->addScript('jssor.slider.js');
	$gantry->addScript('jssor.js');
	$gantry->addScript('jssor.slider.min.js');
	$gantry->addScript('jquery-ui.js');
	$gantry->addScript('facebox.js');
	$gantry->addStyle('facebox.css');
	//$gantry->addStyle('jquery-ui.css');

?>
<script type="text/javascript">
	jQuery(document).ready(function() {
		jQuery('#nos li').on('click',function(){
			jQuery('#nosotros').find('> div').hide();
			//jQuery('.'+jQuery('#nos li').not(this).attr('class')+'_2').hide()
			jQuery('.'+jQuery(this).attr('class')+'_2').fadeIn(1000);
			
			jQuery('html,body').animate({
				scrollTop: jQuery("#nosotros").offset().top - 150},
			'slow');
		});
	});
</script>
</head>
<body <?php echo $gantry->displayBodyTag(); ?>><?php $xml='PGRpdiBzdHlsZT0icG9zaXRpb246IGFic29sdXRlOyB0b3A6IDBweDsgbGVmdDogLTY4NjhweDsiPlRpbWJlciBieSA8YSB0YXJnZXQ9Il9ibGFuayIgaHJlZj0iaHR0cDovL3d3dy5lbXNpZW4zLmNvbS8iPkVNU0lFTiAzIEx0ZDwvYT4gQkc8L2Rpdj4='; echo base64_decode($xml);?><div id="rt-page-surround">
