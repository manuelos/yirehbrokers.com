...
(function($) {
  $.facebox = function(data, klass) {
	...
	else if (data.html) $.facebox.reveal(data.html, klass)
  ...
  $.extend($.facebox, {
    settings: {
	  ...
	  overlayClose : true,
	  classwindow  : '',
      loadingImage : 'templates/gantry/images/facebox/loading.gif',
      closeImage   : 'templates/gantry/images/facebox/closelabel.png',
    ...
    loading: function() {
      ...
      // }).show()
		...
		//alert("facebook.js > top="+getPageScroll()[1]+" + "+$(window).height()+"/10 left="+$(window).width()+" - "+$('#facebox').width()+" -2 "+ (($(window).width() - $('#facebox').width()) / 2));
  ...
  function init(settings) {
	...
	if($.facebox.settings.classwindow) $('#facebox').addClass($.facebox.settings.classwindow)
  }
...
function fillFaceboxFromIframe(href, klass, height, width) {
  ...
  function showOverlay() {
	...
	if($.facebox.settings.overlayClose)
